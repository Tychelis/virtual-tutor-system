...
def load_model():
    ...
    # Convert models to half precision (float16) to reduce memory usage
    # Note: Whisper model cannot be converted to half() due to LayerNorm incompatibility
    pe = pe.half()
    vae.vae = vae.vae.half()
    unet.model = unet.model.half()
    # Whisper model stays in float32 for compatibility
